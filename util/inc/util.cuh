 ...
 */
template <typename T>
class RealDataHistogram{
 public:
  unsigned *data = NULL; ///< Unified Memory to hold generated uniform distributed random numbers in float
  
  //! Constructor of RealDataHistogram class.
  /*!
   */
 RealDataHistogram(T *raw, int ndata, float min, float max, int nblock, int nthread)
  ...
  //! Deconstructor of RealDataHistogram class.
  /*!
   * 
   * - free device memory at the class life end
   */
