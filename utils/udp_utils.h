 ...
 * @param[in] ip        IP address, 0.0.0.0 is INADDR_ANY, 255.255.255.255 is INADDR_BROADCAST
 * @param[in] group     multicast group, only be used when mode == MULTICAST
 ...
 * @param[in] mode      socket mode, which can be UNICAST, MULTICAST or BROADCAST
